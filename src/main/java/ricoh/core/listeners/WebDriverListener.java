...
public abstract class WebDriverListener implements WebDriverEventListener {
...
//	}
    ...
    public void beforeFindBy(By by, WebElement element, WebDriver driver) {
        ...
        if (driver instanceof JavascriptExecutor) {
            ((JavascriptExecutor) driver).executeScript("arguments[0].style.border='6px solid yellow'", webElement);
            ((JavascriptExecutor) driver).executeScript("arguments[0].style.border='6px solid red'", webElement);
            ((JavascriptExecutor) driver).executeScript("arguments[0].style.border='6px solid blue'", webElement);
            ((JavascriptExecutor) driver).executeScript("arguments[0].style.border='0px solid green'", webElement);            
        }
    }
