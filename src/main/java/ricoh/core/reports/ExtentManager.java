...
//	 * Create new test  
//	 */			
//	public synchronized TestCaseReporter addTest(String strName, String StrDesc){
//		ExtentTest objTest = null;		
//		objTest = reporter.createTest(strName, StrDesc);		
//		logMessage("Created new test - " + strName + ", in extent report");
//		return new TestCaseReporter(objTest);
//	}
	 ...
	 * Create a new child test for given test 
	 */			
//	public synchronized TestCaseReporter addChildTest(TestCaseReporter testCaseRep, String strName, String strDesc){
//		ExtentTest objParentTest = testCaseRep.tcReport;
//		ExtentTest objTest = objParentTest.createNode(strName, strDesc);
//		logMessage("Created new child test - " + strName + ", in extent report");
//		return new TestCaseReporter(objTest);
//	}
...
//		test.log(Status.PASS, m);	
	...
	public synchronized boolean attachScreenshot(ExtentTest objTest, Status objStatus, String strSSFileName){
		...
		try{
			...
			if (! new File(this.strScreenshotPath + File.separator + strSSFileName).exists()){
				blnRes = false;
			}else{				
	...
	private void addClientLogo(){
		...
		String strClientLogoRelPath = ".." + File.separator + ".." + File.separator + gblConstants.configDirName + File.separator 
